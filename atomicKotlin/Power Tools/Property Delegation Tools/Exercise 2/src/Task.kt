...
fun main() {
    ...
    capture {
        d
    } eq "IllegalStateException: Property d should be initialized before get."
    capture {
        s
    } eq "IllegalStateException: Property s should be initialized before get."
    capture {
        f
    } eq "IllegalStateException: Property f should be initialized before get."
