...
import propertyDelegationExercise2.Delegator
import kotlin.reflect.KProperty

class Holder<E> {
  private var list = listOf<E>()
  operator fun getValue(r: Holders, property: KProperty<*>): List<E> = list

  operator fun setValue(w: Holders, property: KProperty<*>, value: List<E>) {
    list = value
  }
}
